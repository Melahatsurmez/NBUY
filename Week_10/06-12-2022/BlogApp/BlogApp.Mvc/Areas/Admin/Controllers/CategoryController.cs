...
namespace BlogApp.Mvc.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Update(int categoryId) // httppost demedik çünkü update yapmadan önce kartın ekrana gelmesi gerek o yüzden bubir  get metoduru
        {
        ...
        public async Task<IActionResult> Update(CategoryUpdateDto categoryUpdateDto)
        {
            if (ModelState.IsValid)
            {
                var result = await _categoryService.Update(categoryUpdateDto, "Melahat Sürmez");
                if (result.ResultStatus==ResultStatus.Success)
                {
