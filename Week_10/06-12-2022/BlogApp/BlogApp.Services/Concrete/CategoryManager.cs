...
namespace BlogApp.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IDataResult<CategoryDto>> Update(CategoryUpdateDto categoryUpdateDto, string modifiedByName)
        {
            ...
            var category = _mapper.Map<CategoryUpdateDto,Category>(categoryUpdateDto, oldCategory); //categoryin içerisinde olup update de olmayanları dahil ettik
        ...
        public async Task<IDataResult<CategoryUpdateDto>> GetCategoryUpdateDto(int categoryId)
        {
            ...
            {
                var category = await _unitOfWork.Categories.GetAsync(c => c.Id == categoryId);
                var categoryUpdateDto= _mapper.Map<CategoryUpdateDto>(category); //elimizdeki  category tipi Category tipinde direkt datanın içinde atamıyoruz o yüxden categoryUpdateDto oluşturup içine atıyoruz
                //categoryi al categoryUpdateDto tipinde dönüştür onuda data resulta at
