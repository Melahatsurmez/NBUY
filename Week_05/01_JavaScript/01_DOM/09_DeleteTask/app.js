        ...
        gorevListesi.push(
            {
                ...
                'gorevAdi':ilkHarfiBuyut(txtTaskName.value) //Ödev:Her kelimenin ilk harfini büyütecek functionu yazınız.
            }
        );
        displayTasks();
    }else{
...
function removeTask(id){
    ...
    //2// deletedId=gorevListesi.findIndex(function(gorev){
    //     return gorev.id==id;
    // });

    //3// deletedId=gorevListesi.findIndex(gorev=>gorev.id==id);

    //Artık görevListesi dizisinden kaçıncı elemenın silineceginş biliyoruz. deletedİd. sıradaki elemanı sileceğiz.
