    ...
    public class CardController : Controller
    {
        ...
        public async Task<IActionResult> Checkout(OrderDto orderDto)
        {
            if (ModelState.IsValid)
            {
                ...
                //Yapılan Satışı Kaydetme işlemi(Save Order)
        ...
        private async void SaveOrder(OrderDto orderDto,string userId)
        {
            ...
            order.OrderState = EnumOrderState.Unpaid; //Bunu Geçici olarak yapıyoruz aslında buraya ödeme tamamlanmış halde gelecegiz buranın unpaid değil completed olmasını sağlayacagız.
