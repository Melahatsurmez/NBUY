...
namespace ShoppingApp.Web.Controllers
{
    ...
    public class CardController : Controller
    {
        ...
        private bool CardNumberControl(string cardNumber)
        {
             ...
             * -Luhn algroitmasını uygulamak için gerekeni yap
             */
            #endregion
        ...
        {
            #region PaymentOptionCreated
            Options options = new Options();
            options.ApiKey = "sandbox-o1p5VuY1gqiSVECmgaqini0efnxG9vWP";
            options.SecretKey = "sandbox-HFynr6qobHjSrN6dPqibfDouxPjLa43o";
            ...
            CreatePaymentRequest request = new CreatePaymentRequest
            {
                ...
                Buyer = new Buyer
                {
                    ...
                    Name = "Wissen",
                    Surname = "Akademi",
                    GsmNumber = "+905558788978",
                    Email = "wissen@gmail.com",
                    IdentityNumber = "74300464791",
                    RegistrationAddress = "Barbaros Bulvarı Yıldız İş Merkezi",
                    Ip = "85.34.115.78",
                    City = "İstanbul",
                    Country = "Turkiye"
                },
                ShippingAddress = new Address
                {
                    ...
                    City = "İstanbul",
                    Country = "Türkiye",
                    Description = "Barbaros Bulvarı Yıldız İş Merkezi"
                },
            ...
            foreach (var item in orderDto.CardDto.CardItems)
            {
                ...
                basketItem.Category1 = "Genel";//Bu b,ze aslında carddto içerisindeki productların category bilgilerinide doldurmamız gerektiğini hatırlattı.
