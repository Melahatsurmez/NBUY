...
namespace ShoppingApp.Web.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Edit(UserAddDto userUpdateDto)
        {
            ...
            userUpdateDto.SelectedRoles = userUpdateDto.SelectedRoles ?? new List<string>(); //Hiçbir role seçilmezse null geleceğinden bunu ekliyoruz. SelectedRole u boş yarattık 
            return View(userUpdateDto);
        }
        //Ödev:Roller ve kullanıcılar ile ilgili silme işlemlerinide tamamlayın.
    }
}
