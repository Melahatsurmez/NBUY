...
namespace BlogApp.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IResult> Add(ArticleAddDto articleAddDto, string createdByName)
        {
            ...
            article.UserId = 1;
            #region Açıklamalar
            //User ıd yi şimdilik elle veriyoruz login işlemlerini tamamladıgımızda burayı değiştiriyor olacagız.
            //Eğere entity base içerisinde createddate için default deger vermemiş olsaydık böyle yapabildirdik.Bunun ikinci bir yoluda profile içinden bu degeri vermektir.
