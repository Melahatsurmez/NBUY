...
builder.Services.AddDbContext<IdentityContext>(options=>options.UseSqlite(builder.Configuration.GetConnectionString("SqliteConnection"))); //veri tabanýn yolunu sildik onu burda çaðýrdýk veri tabanýmýzýn yolu appsettings.json da o dosya gzilenebiliyo
...
builder.Services.Configure<IdentityOptions>(options =>
{
    ...
    options.Lockout.DefaultLockoutTimeSpan = TimeSpan.FromSeconds(10); //Kilitlenmiþ hesabýn, tekrar giriþ deneme yapmasý için 5 dakika beklemesi gerekir.
    #endregion
    #region UserSettings
